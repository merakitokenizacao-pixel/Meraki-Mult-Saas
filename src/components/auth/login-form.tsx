...
export function LoginForm() {
  ...
  return (
    <div className="flex min-h-dvh items-center justify-center bg-vx-bg px-4 py-10">
      <div className="w-full max-w-[380px]">
        ...
        <form
          onSubmit={onSubmit}
          className="rounded-2xl border border-vx-border bg-vx-surface p-7"
        ...
        >
          <div className="mb-4">
            ...
            <div className="relative">
              <Mail
                size={15}
                strokeWidth={1.5}
                className="pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 text-vx-muted"
              />
              <input
                id="email"
                type="email"
          ...
          {erro && (
            <div className="mb-4 flex items-start gap-2 rounded-xl bg-vx-red-bg px-3.5 py-2.5 text-[12.5px] leading-snug text-vx-red">
        ...
        <p className="mt-6 text-center text-[11.5px] leading-relaxed text-vx-muted">
