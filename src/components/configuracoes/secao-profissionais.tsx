...
export function SecaoProfissionais() {
  ...
  if (error) {
    return (
      <div className="config-card">
        <div style={{ display: "flex", gap: 9, alignItems: "flex-start", color: "var(--mk-alerta)", fontSize: 13 }}>
          <TriangleAlert size={16} strokeWidth={1.8} style={{ marginTop: 1, flexShrink: 0 }} />
          <div>
            <div style={{ fontWeight: 600, marginBottom: 3 }}>
              Não foi possível carregar as profissionais.
            </div>
            <div style={{ color: "var(--mk-tinta-fraca)", fontSize: 12.5 }}>
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
      ...
      {profissionais.length === 0 && (
        <div className="config-card">
          <p style={{ fontSize: 13, color: "var(--mk-tinta-fraca)", margin: 0, lineHeight: 1.55 }}>
