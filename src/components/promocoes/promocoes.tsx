...
const TOM: Record<string, { bg: string; fg: string }> = {
  vigente: { bg: "var(--mk-ativa-fraca)", fg: "var(--mk-ativa)" },
  vencida: { bg: "var(--mk-superficie-2)", fg: "var(--mk-tinta-fraca)" },
  desativada: { bg: "var(--mk-superficie-2)", fg: "var(--mk-tinta-fraca)" },
};
    ...
    <div className="page-fade">
      ...
      {isPending ? (
        ...
        <div className="card" style={{ padding: 32, textAlign: "center" }}>
          <Tag size={26} strokeWidth={1.4} style={{ color: "var(--mk-acento)", margin: "0 auto 12px" }} />
              ...
              >
                <div className="promo-badges">
                  ...
                  {p.anuncio_ativo && (
                    <span
                      className="promo-badge"
                      style={{ background: "var(--mk-aviso-fraca)", color: "var(--mk-aviso)" }}
                    >
